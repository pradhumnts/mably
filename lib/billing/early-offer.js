...
export const EARLY_OFFER_DEMO_PORTAL_HREF = DEMO_PORTAL_HREF;
...
export const EARLY_OFFER_PLANS = [
  {
    ...
    listPriceMonthly: 9,
    features: ["Files & links", "Invite multiple clients", "Project chat", "1 GB storage"],
  },
  {
    key: "growth",
    label: "Growth",
    description: "Unlimited projects · more storage",
    listPriceMonthly: 19,
