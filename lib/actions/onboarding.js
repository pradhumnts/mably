 ...
 * @param {{ marketingEmails?: boolean }} [options]
 */
export async function completeFreelancerOnboarding(category, options = {}) {
  ...
  const marketingEmails = options.marketingEmails === true;
  ...
  const notification_preferences = mergeAllNotificationPreferences({
    ...mergeAllNotificationPreferences(prefRow?.notification_preferences),
    marketingEmails,
    marketingEmailConsentAt: onboardedAt,
  });
