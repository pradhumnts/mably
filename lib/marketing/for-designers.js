...
export const FOR_DESIGNERS = {
  ...
  stepsIntro:
    "Set up a branded client experience, invite your client (and anyone else who needs access), and keep mockups, revisions, and visual approvals in one place clients understand.",
  steps: [
    {
    ...
    {
      title: "Send one link.",
      copy: "Invite clients and stakeholders to open mockups, Figma links, and staging URLs without a buried email thread.",
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Create a project for the engagement, add your branding, drop in files or Figma/Loom links, and invite the client. Need a creative director or second stakeholder on the same project? Invite them from Settings → People. They review, comment, and approve without hunting through email.",
    },
    {
      q: "Can more than one person access a design project?",
      a: "Yes. Invite extra clients or stakeholders from Settings → People — same portal, same files and approvals.",
    },
    {
