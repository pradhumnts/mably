...
export const FOR_AGENCIES = {
  ...
  stepsIntro:
    "Set up a branded client experience for each engagement, invite the client team, and keep delivery clear for everyone who needs eyes on the work.",
  steps: [
    {
    ...
    {
      title: "Send one link.",
      copy: "Invite the primary contact — and extra stakeholders — so the whole client side can open files and updates.",
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes — two ways. Create a project per engagement (Growth unlocks unlimited projects). And on any project, invite as many client stakeholders as you need from Settings → People — same portal, no seat fees.",
    },
    {
      q: "Can more than one person access the same project?",
      a: "Yes. Invite extra clients or stakeholders from Settings → People. They get their own login to the same branded workspace.",
    },
    {
