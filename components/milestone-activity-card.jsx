...
import { ChevronDown, ChevronUp, Calendar, RotateCcw, MoreVertical, Link as LinkIcon, AlertTriangle, Flag, CheckCircle, Upload, MessageCircle, Circle, DollarSign } from "lucide-react";
...
export function MilestoneActivityCard({ milestone }) {
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 text-sm mt-[16px]">
            <div className="flex items-center gap-1.5 font-medium">
              <span className="w-2 h-2 rounded-full" style={{ backgroundColor: milestone.status === "In Progress" ? "#f97316" : "#22c55e" }} />
              {milestone.status}
            </div>
            {/* Vertical Divider */}
            ...
            <div className="flex items-center gap-1.5 font-medium">
              ...
              <span>{milestone.revisions} Revisions Done</span>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {activity.badge && (
                      <Badge 
                        variant="secondary" 
                        className={cn("text-xs flex items-center gap-1 border py-[12px] px-[6px]", getActivityBadgeColor(activity.badge.type))}
                      >
                  ...
                  {/* Nested Comment */}
                  {activity.comment && (
                    <Card className="mt-3 p-4 bg-muted/30 w-fit">
