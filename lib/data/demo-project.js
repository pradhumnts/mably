...
export function getDemoProjectActivityPageData(freelancer) {
  ...
  const activities = [
    ...
    },
    {
      ...
      action: "Commented on",
      timestamp: "Yesterday",
      fileLink: "Style guide draft.pdf",
      comment:
        "Great start! Could we tighten the spacing tokens and add a section on motion before we share with the team?",
    ...
    },
    {
      ...
      timestamp: "1 week ago",
      fileLink: "Logo concepts v1.png",
      comment: "Love direction 2! Could we explore a wordmark version too?",
    ...
    },
    {
      ...
      action: "Uploaded",
      timestamp: "1 week ago",
      fileLink: "Brand brief & references.pdf",
      fileMetadata: { needsApproval: false },
      destinationHref: `/project/${DEMO_PROJECT_ID}/library/files`,
      destinationLabel: "Open in library",
      externalHref: null,
...
export function getDemoLibraryFiles(freelancer) {
  ...
  return [
    {
      id: "demo-file-5",
      display_name: "Style guide draft.pdf",
      original_filename: "style-guide-draft.pdf",
      mime_type: "application/pdf",
      size_bytes: 3_880_000,
      description: "First pass at the brand style guide. Tokens, type scale, motion principles.",
      needs_approval: true,
    ...
    {
      id: "demo-file-1",
      display_name: "Brand brief & references.pdf",
      original_filename: "brand-brief.pdf",
      mime_type: "application/pdf",
      size_bytes: 2_310_000,
      description: "Brand brief, audience notes, competitor references, and a few visual benchmarks.",
      needs_approval: false,
      approval_status: null,
...
export function getDemoProjectChatBootstrap(freelancer) {
  ...
  const messages = [
    ...
    },
    {
      id: "demo-msg-7",
      content:
        "Style guide draft is up in the library now. Let me know what you think — happy to iterate on anything before we share with the team.",
      authorId: flAuthorId,
    ...
    },
    {
      id: "demo-msg-8",
      content:
        "Quick note on the style guide — left a comment on the file. Mostly spacing tokens + a small motion section.",
      authorId: clientAuthorId,
