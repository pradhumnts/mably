...
/** @typedef {'unread_chat' | 'file_revision' | 'invoice_overdue' | 'portal_not_opened' | 'due_soon' | 'client_opened_portal' | 'payment_received' | 'project_created' | 'activity_comment' | 'activity_file_upload' | 'activity_invoice_sent' | 'activity_approval' | 'activity_action_completed'} NotificationType */
