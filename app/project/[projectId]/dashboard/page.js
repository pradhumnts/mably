...
const dashboardCards = [
  {
    ...
    description: "Catch up on what's happening in the project",
    icon: Calendar,
    href: "/activity",
  },
  {
    id: "library",
    title: "Library",
    description: "Access shared files, links, and deliverables",
    icon: Folder,
    href: "/library/files",
  },
  {
    id: "payments",
    title: "Payments",
    description: "Review invoices and pay securely",
    icon: CreditCard,
    href: "/payments",
  },
];
