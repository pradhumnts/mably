 ...
 * @param {{ demoAsClient?: boolean }} [options] — demo portal view switch only
 */
export async function getPortalHomeBriefing(projectId, options = {}) {
  ...
  if (isDemoProjectId(pid)) {
    ...
    return getDemoPortalHomeBriefing(freelancer, {
      isFreelancer: !options?.demoAsClient,
    });
  }
