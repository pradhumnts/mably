...
export function getCanonicalMarketingUrl() {
  // Vercel canonicalizes mably.io → www.mably.io (308). Sitemap + canonicals must
  // use www or crawlers flag "3XX redirect in sitemap" / "canonical points to redirect".
  return trimOrigin(process.env.NEXT_PUBLIC_MARKETING_URL) || "https://www.mably.io";
}
