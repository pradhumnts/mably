...
export const WHATS_NEW_GROUPS = [
  {
    ...
    items: [
      {
        category: { emoji: "👥", label: "Access", className: "text-indigo-700 bg-indigo-50" },
        title: "Invite more than one client to a project",
        description:
          "When a project needs a second set of eyes — a manager, a stakeholder, another decision-maker — invite them from Settings → People. Same portal, same files and approvals.",
        bullets: [
          "Add extra clients by email from project Settings → People",
          "Everyone invited gets their own login to the same portal",
          "Invite as many people as you need — no seat fees",
        ],
      },
    ],
  },
  {
    ...
    items: [
      {
        category: { emoji: "✅", label: "Actions", className: "text-lime-700 bg-lime-50" },
        title: "Actions — deadlines and follow-ups in the portal",
        description:
          "Track what you need from a client (or yourself) without another spreadsheet. Assign an owner, set a due date, and keep the thread next to the project.",
        bullets: [
          "Create actions for you or share them with the client",
          "Open an action to read details, then edit when you need to",
          "See open and completed lists with overdue and due-today cues",
        ],
      },
      {
        category: { emoji: "📎", label: "Mentions", className: "text-violet-700 bg-violet-50" },
        title: "Mention files and links with @",
        description:
          "Point someone at the right deliverable mid-conversation. Type @ in chat, file discussion, or an action description — pick a library file or link, and the chip opens the preview.",
        bullets: [
          "Works in project messages, file discussions, and action descriptions",
          "Search your project library as you type",
          "Click a mention to open file preview or the linked item",
        ],
      },
      {
        category: { emoji: "💬", label: "Messages", className: "text-sky-700 bg-sky-50" },
        title: "Messages inbox across projects",
        description:
          "Freelancers get a home for every project conversation — jump between clients without digging through each portal first.",
        bullets: [
          "See all project chats in one Messages screen",
          "Unread counts so nothing slips by",
          "Same chat experience as the in-project floating widget",
        ],
      },
      {
        category: { emoji: "🏠", label: "Dashboard", className: "text-orange-700 bg-orange-50" },
        title: "A smarter project home",
        description:
          "The project dashboard now surfaces what needs attention — approvals, invoices, and shared actions — plus a quick peek at the latest activity.",
        bullets: [
          "Attention list for things waiting on you or the client",
          "Latest activity without leaving the home screen",
          "Faster paths into library, payments, and actions",
        ],
      },
    ],
  },
