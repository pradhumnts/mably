...
/** Total library storage (GiB) across all projects for the billing account (Growth). */
export const GROWTH_LIBRARY_TOTAL_GIB = 25;

/** Total library bytes across all projects for the billing account (Growth). */
export const GROWTH_LIBRARY_TOTAL_BYTES = GROWTH_LIBRARY_TOTAL_GIB * STORAGE_GIB;

/** Human-readable Growth account storage cap (marketing + UI). */
export const GROWTH_LIBRARY_TOTAL_LABEL = `${GROWTH_LIBRARY_TOTAL_GIB} GB`;
